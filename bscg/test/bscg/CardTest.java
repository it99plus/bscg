...
public class CardTest {
	...
	public void test_toString() {
		// assertEquals(card.getCardNumber() + " " + "56xx-xxxx-xxxx-xxxx" + " "
		// + card.getExpiryDate(),card.toString());
	}
	...
	public void test_compareTo() {
		...
		assertEquals("return 0 if they are equal - test key is expiry date", 0,
				card.compareTo(oCard));
		card.createNewCard("HSBC Canada", "5601-2345-3446-5678", "Nov-2017");
		oCard.createNewCard("HSBC Canada", "5601-2345-3446-5678", "Nov-2018");
		assertEquals(
				"return -1 if they are not equal - test key is expiry date",
				-1, card.compareTo(oCard));
